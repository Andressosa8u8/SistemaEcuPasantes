<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Views_Pasantes/Pasantes.Master" AutoEventWireup="true" CodeBehind="Numero_Horas.aspx.cs" Inherits="SistemaEcuPasantes.Template.Views_Pasantes.Numero_Horas" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Total de horas completadas</h4>
                        <div class="container">
                            <div class="row">
                                <div class="col-9">
